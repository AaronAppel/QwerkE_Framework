...
namespace QwerkE {
    ...
    public:
        ...
        const std::map<std::string, Mesh*>* SeeMeshes() const { return &m_Meshes; };
        const std::map<std::string, Texture*>* SeeTextures() const { return &m_Textures; };
        const std::map<std::string, Material*>* SeeMaterials() const { return &m_Materials; };
        // const std::map<std::string, >* LookAtFonts() const { return &; };
        const std::map<std::string, ALuint>* SeeSounds() const { return &m_Sounds; };
        const std::map<std::string, ShaderProgram*>* SeeShaderPrograms() const { return &m_ShaderPrograms; };
        const std::map<std::string, ShaderComponent*>* SeeShaderComponents() const { return &m_ShaderComponents; };
