...
namespace QwerkE {
    ...
    {
        ShaderComponent* result = ((ShaderFactory*)QwerkE::Services::GetService(eEngineServices::Factory_Shader))->GenerateShaderFromData(type, shaderData);
        ...
        if (result)
        {
            ...
            // link new shader
            ((ShaderFactory*)QwerkE::Services::GetService(eEngineServices::Factory_Shader))->LinkCreatedShaderProgram(this);
